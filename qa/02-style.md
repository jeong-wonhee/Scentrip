...
| # | 구분 | 항목 | 위치 | 기대(원본) | 근거 | 실제(배포) | 증거 | 뷰포트 |
|---|---|---|---|---|---|---|---|---|
| F031 | P1 | AI 동선 배너 버튼 아이콘 위치·모양 불일치 | https://scentrip.vercel.app/ — '나만의 동선 만들기' 버튼 | 왼쪽 반짝임(✦ sparkle) 아이콘 + 라벨 | `screens/home.html:410-412` | 라벨 + 오른쪽 화살표(→) 아이콘 | qa/screens/home-member-1440-dev.png | all |
| F032 | P1 | 섹션 '전체 보기' 링크에 chevron 추가 | https://scentrip.vercel.app/ — 장소 추천·동선·로컬 섹션 우측 '전체 보기 >' | 텍스트만 '전체 보기' | `screens/home.html:390` | '전체 보기' + 오른쪽 chevron 아이콘 | qa/screens/home-member-1440-dev.png | all |
